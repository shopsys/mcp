...
class McpRequestLogProcessor
{
    ...
    public function __invoke(LogRecord $record): LogRecord
    {
        ...
        $record['extra']['administrator_id'] = $administratorMcpToken->getAdministrator()->getId();
        $record['extra']['administrator_username'] = $administratorMcpToken->getAdministrator()->getUsername();
